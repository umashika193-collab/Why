...
export const currentInflowSectorsData: CurrentInflowSector[] = [
  ...
  },
  {
    ...
    inflowAmountEn: "$140.7B / Quarter",
    inflowGrowth: "+69% YoY",
    inflowGrowthEn: "+69% YoY",
    growthNum: 69,
    shareRatio: 19,
  ...
  },
  {
    ...
    inflowAmount: "$121 億 / 四半期",
    inflowAmountEn: "$120.8B / Quarter",
    inflowGrowth: "+24% YoY",
