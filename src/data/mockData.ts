...
export const currentInflowSectorsData: CurrentInflowSector[] = [
  {
    ...
    inflowAmount: "$213 億 / 四半期",
    inflowAmountEn: "$212.9B / Quarter",
    inflowGrowth: "+32% YoY",
  ...
  },
  {
    ...
    inflowAmount: "$149 億 / 四半期",
    inflowAmountEn: "$149.2B / Quarter",
    inflowGrowth: "+35% YoY",
  ...
  },
  {
    ...
    inflowAmountEn: "$136.5B / Quarter",
    inflowGrowth: "+62% YoY",
    inflowGrowthEn: "+62% YoY",
    growthNum: 62,
    shareRatio: 18,
  ...
  },
  {
    ...
    inflowAmount: "$117 億 / 四半期",
    inflowAmountEn: "$116.9B / Quarter",
    inflowGrowth: "+48% YoY",
